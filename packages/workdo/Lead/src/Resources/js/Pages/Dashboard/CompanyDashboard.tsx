                            ...
                            <CalendarView
                                events={calendarEvents.map(event => {
                                    ...
                                    if (event.type === 'Lead Task') {
                                        color = event.status === 'completed' ? '#10b77f' : '#3b82f6'; // Green for completed, blue for pending lead tasks
                                    } else {
                                        color = event.status === 'completed' ? '#10b77f' : '#f59e0b'; // Green for completed, orange for pending deal tasks
                                    }
